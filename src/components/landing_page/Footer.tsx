            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                    ...
                    <div className="flex items-center gap-4 mt-6 md:mt-0">
                        <Link href="https://twitter.com/contrails_ai" target="_blank" rel="noopener noreferrer" className="transition-colors h-5 w-5 text-gray-600 hover:text-[#0253E4]">
                            {/* TWITTER /X */}
                            <svg
                        ...
                        <Link href="https://www.linkedin.com/company/contrails-ai" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#0253E4] transition-colors">
